...
try:
    ...
    ser = serial.Serial('COM3', 9600, timeout=1)     #enter ur arduino COM port number
...
# Initialize Blynk
token = '8fff08c769f44b81bd45f0cbcd807137'

myAPI = "889I79TV2TGYHYG8"
...
while(cap.isOpened()):
    ...
    if ret==True:
        ...
        print(str_up)
        print(str_down)
        if cnt_up > 15 and flag == 1:
            ser.write(b'1')
            flag = 0
            
        if cnt_down > 15 and flag1 == 1:
            ser.write(b'2')
            flag1 = 0
